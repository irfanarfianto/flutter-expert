...
import 'package:submission_flutter_expert/common/failure.dart' as i8;
import 'package:submission_flutter_expert/data/datasources/db/database_helper.dart' as i15;
import 'package:submission_flutter_expert/data/datasources/movie_local_data_source.dart' as i13;
import 'package:submission_flutter_expert/data/datasources/movie_remote_data_source.dart'
    as i11;
import 'package:submission_flutter_expert/data/models/movie_detail_model.dart' as i3;
import 'package:submission_flutter_expert/data/models/movie_model.dart' as i12;
import 'package:submission_flutter_expert/data/models/movie_table.dart' as i14;
import 'package:submission_flutter_expert/domain/entities/movie.dart' as i9;
import 'package:submission_flutter_expert/domain/entities/movie_detail.dart' as i10;
import 'package:submission_flutter_expert/domain/repositories/movie_repository.dart' as i6;
  ...
  i7.Future<i2.Either<i8.Failure, List<i9.Movie>>> getNowPlayingMovies() =>
      (super.noSuchMethod(Invocation.method(#getNowPlayingMovies, []),
          returnValue: Future<i2.Either<i8.Failure, List<i9.Movie>>>.value(
              _FakeEither<i8.Failure, List<i9.Movie>>())) as i7
  ...
  i7.Future<i2.Either<i8.Failure, i10.MovieDetail>> getMovieDetail(
      ...
      (super.noSuchMethod(Invocation.method(#getMovieDetail, [id]),
          returnValue: Future<i2.Either<i8.Failure, i10.MovieDetail>>.value(
              _FakeEither<i8.Failure, i10.MovieDetail>())) as i7
